      	...
      	<ul style="width: 3000em; position: relative; z-index: 9; top: 0px; left: 0px;">
			...
			<?php $li_bool=false;$li_i=0;foreach ($data['color'] as $value){
				...
				<div style="width: 800px;float: left;">
				 <?php } ?>
			<li><div class="border5a div_table" style="height:149px;overflow: hidden;width:100px"><div class="div_table_cell" style="padding:0"><a ><img src="<?php if(empty($value['url'])){echo '/';}else{ echo $domain.$value['url'].'?imageView2/2/w/100/h/149';} ?>" onerror="imgonerror(this,100,149)"/></a></div></div>
...
<div class="m_body4 cpics_list">
	<ul>
    	...
    	<li img_id="<?php echo Comm::strencrypt($value->id)?>" img_id2="<?php echo $value->id?>" class="img_id_<?php echo $value->id?>" c_o_id="<?php echo $id_to_str_arr[$value->clothes_order_id]?>">
       	  <div class="cpic_t1">
...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/Resize.js"></script>
<script src="<?php echo Yii::app()->request->baseUrl; ?>/js/Drag.js"></script>
<script>

var user_type='<?php echo $_SESSION['type']?>';
var brandnumber='<?php echo $data['clothes']['brandnumber']?>';
var id='<?php echo Comm::strencrypt($data['clothes']['id'])?>';
var id_sku='<?php echo implode(',',$id_to_str_arr)?>';
