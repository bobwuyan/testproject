...
Resize.prototype = {
  ...
  initialize: function(obj, options) {
	this._obj = Jqurey_get_id(obj);//缩放对象
	...
	this._mxContainer = Jqurey_get_id(this.options.mxContainer) || null;
	this.__mxContainer = this.options.mxContainer;
	...
	this.onResize_end = this.options.onResize_end;
  ...
  SetOptions: function(options) {
    this.options = {//默认值
		...
		onResize_end:function(obj_id){},//缩放结束时执行
    };
    Extend(this.options, options || {});
  },
  //设置触发对象
  Set: function(resize, side) {
	var resize = Jqurey_get_id(resize), fun;
	if(!resize) return;
	//根据方向设置
  ...
  //停止缩放
  Stop: function() {
	  this.onResize_end(this.__mxContainer);
